(function(a){
    a.fn.webwidget_html5_star_backgorund=function(p){
        var p=p||{};

        var w_w="2000";//p&&p.window_width?p.window_width:"1000";
        var w_h="1000";//p&&p.window_height?p.window_height:"1000";
        var w_b="#000000";//p&&p.window_background?p.window_background:"#000000";
        var s_c=p&&p.star_count?p.star_count:"600";
        var s_color=p&&p.star_color?p.star_color:"#FFFFFF";
